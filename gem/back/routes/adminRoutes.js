...
// Controladores
const { createAdminEmployee, getAllStaff, updateStaff, deleteStaff } = require('../controllers/userController');
const { 
...
router.route('/users/:id') // <--- Nuevas rutas ID
    .put(updateStaff)
    .delete(deleteStaff);
