...
import { useAuth } from '../../hooks/useAuth.js'; // Usamos el hook de Auth
...
const LoginScreen = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // El AuthContext maneja el token, solo redirigimos
      switch (userRole) {
        case 'administrador':
    ...
    <div className="min-h-screen flex items-center justify-center bg-pink-100 p-4">
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
        <h2 className="text-3xl font-extrabold text-center text-pink-600 mb-6">
          <span role="img" aria-label="Palomitas">🍿</span> Happy Factory
        </h2>
        ...
        {/* Opción para Clientes que necesitan registrarse */}
