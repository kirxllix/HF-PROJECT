...
// ✅ Importar íconos
import { IceCream, Flame, Heart, Star } from 'lucide-react';
...
const renderStars = (rating) => {
    return (
        <div className="flex text-yellow-400 space-x-1">
            {[...Array(5)].map((_, i) => (
                <Star key={i} size={18} fill={i < rating ? "currentColor" : "none"} className={i < rating ? "text-yellow-400" : "text-gray-300"} />
            ))}
        </div>
    );
};
  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans">
      ...
      <div className="relative h-[500px] flex items-center justify-center text-center text-white px-4">
        ...
        <div className="relative z-20 max-w-3xl animate-fade-in-up flex flex-col items-center">
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 drop-shadow-lg tracking-tight">
            Happy Factory
          </h1>
          <p className="text-xl md:text-2xl mb-8 font-light opacity-90 flex items-center gap-2">
              Donde la felicidad tiene sabor a helado <IceCream size={28} />
          </p>
        ...
        <section className="py-12 bg-yellow-50 border-b border-yellow-100">
            <div className="max-w-7xl mx-auto px-6">
                <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center flex items-center justify-center gap-2">
                    <Flame className="text-orange-500" size={32} /> Promociones del Mes
                </h2>
      ...
      <section className="bg-white py-20">
        <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl font-bold text-gray-800 mb-12 text-center flex items-center justify-center gap-2">
                Lo que dicen nuestros Happy Clientes <Heart className="text-red-500" fill="currentColor" />
            </h2>
